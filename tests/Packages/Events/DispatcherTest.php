...
{
    /**
     * @var \TGL\Packages\Events\Dispatcher
     */
    private $dispatcher;

    public function setUp()
    {
        $this->dispatcher = new \TGL\Packages\Events\Dispatcher();
    }
...
class ListenerStub implements \TGL\Packages\Events\Contracts\Listener{
